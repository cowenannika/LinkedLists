            ...
            }else
            {
                ...
                switch(option){
                    ...
                    case 2:
                        System.out.println("What value do you want to add: ");
                        value = scanner.next();
                        System.out.println("What position do you want to add it at: ");
                        pos = scanner.nextInt();
                        l.add(value, pos);
                        break;
                    case 3:
                        System.out.println("Enter position that you want to remove: ");
                        pos = scanner.nextInt();
                        l.remove(pos);
                        break;
                    case 4:
                        System.out.println("Enter position that you want to get: ");
                        pos = scanner.nextInt();
